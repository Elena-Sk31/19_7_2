...
class PetFriends:
    ...
    def __init__(self):
        # self.base_url = "https://petfriends.herokuapp.com/"
    ...
    def set_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        ...
        :param auth_key: The API key which is used for authentication. The API key can be achieved with /api/key
                            API endpoint.
        :param pet_id: The ID of existing pet
        :param pet_photo: The image file with photo of the pet. The file should be in JPG, JPEG or PNG format.
        :return: ???
        """
        headers = {'auth_key': auth_key['key']}
    ...
    def create_pet_simple(self, auth_key: json, name: str, animal_type: str, age: int) -> json:
        ...
        :param animal_type: The kind of pet (for instance, German Shepherd, Scottish Fold and etc.)
